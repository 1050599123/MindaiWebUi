package org.webdriver.mindaiwebui.pageObjectConfig;
...
public class PageObjectAutoCode {
	...
	static  String path="src/main/java/org/webdriver/mindaiwebui/pageObjectConfig/UILibrary.xml";
	public static void autoCode() throws Exception
	{
		...
		for(Iterator<?> i=root.elementIterator();i.hasNext();)
		{
			...
			sb.append("import org.webdriver.mindaiwebui.utils.BaseAction;\n");
			sb.append("import org.webdriver.mindaiwebui.utils.Locator;\n");
			sb.append("import org.webdriver.mindaiwebui.pageObjectConfig.PageObjectAutoCode;");
			...
			sb.append("private String path=\"src/main/java/org/webdriver/mindaiwebui/pageObjectConfig/UILibrary.xml\";\n");
			...
			File pageObjectFile=new File("src/main/java/org/webdriver/mindaiwebui/pageObject/"+pageClassName+".java");
