		  ...
		  ElementAction action=new ElementAction();
		   ...
		   @DataProvider(name="longinData")
			public Object[][] loginData()
			{
			   ...
			   return ExcelReadUtil.case_data_excel(1, 1, 1, 1, 10,filePath);
			}
		   
	    @Test(description="测试用例",dataProvider = "longinData")
	    public void Login( String userName,String password,String regName,String cardId,String bankCard,String phone, String smsCode, String ppassword, String confirmPassword,String money) throws Exception, DocumentException{ 
			//代替testng参数化的方法
