...
public class RegistrationAction extends TestBaseCase{
    public RegistrationAction(String Url,String regName,String regPass ,String inviter ) throws IOException
    {
        ...
        String imgCode=action.Getgraphicscode(Registrationpage.图形验证码());
